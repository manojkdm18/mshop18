...
<div class="row my-4">
   <div class="col-6">
   <label class="text-muted">Sub Category  ID :</label>
   <input type="text" name="catrfnum" id="catrfnum"/>
   </div>
   <div class="col-6">
   <label class="text-muted">Sub Category Name :</label>
...
<div class="form-check form-check-inline">
  ...
  <label class="form-check-label" for="inlineRadio2">NO</label>
   ...
   <div class="col-4">
   <input type="button" value="SUBMIT" id="subcategorysearchbtn" class="common_submit_btn">
